		...
		function init() {
			...
			info.innerHTML = '<span style="font-size: 12px; color: #ddd; background-color: #252934; border-bottom: 1px solid #252934; padding: 8px 10px; text-transform: uppercase;"><strong>0 - 9</strong>: 색상 변경, <strong>click</strong>: 블럭 추가, <strong>shift + click</strong>: 블럭 제거, <strong>drag</strong>: 회전';
		...
		function onDocumentMouseMove( event ) {
			...
			mouse3D = projector.unprojectVector( new THREE.Vector3( ( event.clientX / renderer.domElement.width ) * 2 - 1, - ( (event.clientY + posY) / renderer.domElement.height ) * 2 + 1, 0.5 ), camera );
